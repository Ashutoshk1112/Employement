import 'package:employement/Component/Card.dart';
              ...
              Row(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text("Frequent Categories",style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w400),),
                  ),
                  GestureDetector(
                      onTap: (){
//                        Navigator.push(context, MaterialPageRoute(builder: (context)=> Worker()) );
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right:18.0),
                        child: Text("Show All>>",style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w400),),
                      )
